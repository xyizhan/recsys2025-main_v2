...
log_dir="logs"
mkdir -p "$log_dir"
embeddings_dir="../autodl-tmp/embeddings_out/contrastive_teacher_diffusion_e3"
score_dir="../scores_out/teacher_diffusion_e3"
mkdir -p "$score_dir"
log_file="$log_dir/contrastive_teacher_diffusion_e3_${timestamp}.log"
...
python -m training_pipeline.train \
  ...
  --log-name teacher_diffusion_e3_gpu \
  --num-workers 10 \
  --accelerator gpu \
  --devices 0 \
  --score-dir "$score_dir"
