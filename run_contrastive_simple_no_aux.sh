...
echo "Auxiliary-task ablation embedding generation launched. Logs: $log_file"
echo "Run ./run_contrastive_simple_no_aux_downstream.sh after embeddings are ready to start downstream training."
