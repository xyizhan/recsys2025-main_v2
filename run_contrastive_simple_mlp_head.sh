...
echo "MLP-head embedding generation launched. Logs: $log_file"
echo "Run ./run_contrastive_simple_mlp_head_downstream.sh after embeddings are ready to start downstream training."
